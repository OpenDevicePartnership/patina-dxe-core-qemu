...
use patina::{
    ...
    component::{IntoComponent, Storage, service::Service},
    error::Result,
};
use patina_smbios::{
...
impl Q35SmbiosPlatform {
    ...
    fn entry_point(self, smbios: Service<dyn Smbios>, storage: &mut Storage) -> Result<()> {
        ...
        match smbios.add_record(None, &end_of_table) {
        ...
        // This exercises the EDKII-compatible protocol functions to verify they work correctly
    ...
    ///
    /// This tests the EDKII-compatible protocol layer (Add, UpdateString, Remove)
