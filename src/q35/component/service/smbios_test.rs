...
#[patina_test]
fn q35_smbios_ffi_test(protocols: Service<dyn ProtocolServices>) -> patina_test::error::Result {
...
fn test_c_protocol_layer(protocols: &Service<dyn ProtocolServices>) -> patina_test::error::Result {
    ...
    const SMBIOS_PROTOCOL_GUID: BinaryGuid =
        BinaryGuid::from_fields(0x03583ff6, 0xcb36, 0x4940, 0x94, 0x7e, &[0xb9, 0xb3, 0x9f, 0x4a, 0xfa, 0xf7]);
