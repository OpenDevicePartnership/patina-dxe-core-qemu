# 🐞 WinDbgX + QEMU + Patina UEFI Debugging Guide
...
[WinDbgX](https://learn.microsoft.com/en-us/windows-hardware/drivers/debuggercmds/windbg-overview)
...
#### Software Debugging: WinDbgX ↔ EXDi ↔ GDB Stub ↔ Serial Port ↔ UEFI Debugger

![WinDbg EXDi QEMU Software Debugging](images/windbg_exdi_qemu_sw_debugging.png)

#### Hardware Debugging: WinDbgX ↔ EXDi ↔ GDB Stub ↔ Serial Port ↔ QEMU HW
...
## Running QEMU with Patina Dxe Core
...
![QEMU Inital break in](images/qemu_initial_break_in.png)

---

## Launching WinDbgX Instances

### Instance 1: Software Debugging

1. Launch **WinDbgX**. This will connect to QEMU SW serial port(`56789`)
...
1. Launch another **WinDbgX** instance
